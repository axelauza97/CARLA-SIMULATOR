...
actor_list = []
centerLocation=carla.Transform(location=carla.Location(x=-43.1,y=-67.2,z=0))
...
def main():
    try:
        ...
        while True:
            ...
            centerLocation=carla.Transform(location=carla.Location(x=-20,y=-97.1,z=0))
            callPedestrians(n,blueprint_library,world)
            centerLocation=carla.Transform(location=carla.Location(x=-50,y=-97.1,z=0))
            callPedestrians(n,blueprint_library,world)
            centerLocation=carla.Transform(location=carla.Location(x=-18.9,y=56.3,z=0))
            callPedestrians(n,blueprint_library,world)
            time.sleep(1)
